...
namespace _16.BitExchangeAdvanced
{
    class BitExchangeAdvanced
    {
        static void Main)
        {
            ...
            Console.WriteLine("Enter the second position you would like to exchange with the first position:");
            int q = int.Parse(Console.ReadLine());
            Console.WriteLine("Enter the number of bits you would like to exchange inbetween:");
